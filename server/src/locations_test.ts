...
describe('locations', function() {
  ...
  it('distanceMoreThan', function() {
    ...
    assert.strictEqual(distanceMoreThan({x: 1, y: 1}, {x1: 0, x2: 2, y1: 0, y2: 2}, 5), false);
    assert.strictEqual(distanceMoreThan({x: 1, y: 4}, {x1: 0, x2: 2, y1: 0, y2: 2}, 5), false);
    assert.strictEqual(distanceMoreThan({x: 1, y: 4}, {x1: 0, x2: 2, y1: 0, y2: 2}, 1), true);
    assert.strictEqual(distanceMoreThan({x: 4, y: 1}, {x1: 0, x2: 2, y1: 0, y2: 2}, 5), false);
    assert.strictEqual(distanceMoreThan({x: 4, y: 1}, {x1: 0, x2: 2, y1: 0, y2: 2}, 1), true);
    assert.strictEqual(distanceMoreThan({x: 4, y: 4}, {x1: 0, x2: 2, y1: 0, y2: 2}, 5), false);
    assert.strictEqual(distanceMoreThan({x: 4, y: 4}, {x1: 0, x2: 2, y1: 0, y2: 2}, 1), true);

    assert.strictEqual(distanceMoreThan({x: 0, y: 0}, {x1: 0, x2: 2, y1: 0, y2: 2}, 5), false);
    assert.strictEqual(distanceMoreThan({x: 0, y: 4}, {x1: 0, x2: 2, y1: 0, y2: 2}, 2), false);
    assert.strictEqual(distanceMoreThan({x: 0, y: 4}, {x1: 0, x2: 2, y1: 0, y2: 2}, 1), true);
    assert.strictEqual(distanceMoreThan({x: 4, y: 0}, {x1: 0, x2: 2, y1: 0, y2: 2}, 2), false);
    assert.strictEqual(distanceMoreThan({x: 4, y: 0}, {x1: 0, x2: 2, y1: 0, y2: 2}, 1), true);
    assert.strictEqual(distanceMoreThan({x: 3, y: 3}, {x1: 0, x2: 2, y1: 0, y2: 2}, 3), false);
    assert.strictEqual(distanceMoreThan({x: 3, y: 3}, {x1: 0, x2: 2, y1: 0, y2: 2}, 1), true);

    assert.strictEqual(distanceMoreThan({x: 0, y: 0}, {x1: 1, x2: 2, y1: 1, y2: 2}, 1), true);
    assert.strictEqual(distanceMoreThan({x: 0, y: 0}, {x1: 1, x2: 2, y1: 1, y2: 2}, 2), false);
    assert.strictEqual(distanceMoreThan({x: 3, y: 3}, {x1: 1, x2: 2, y1: 1, y2: 2}, 1), true);
    assert.strictEqual(distanceMoreThan({x: 3, y: 3}, {x1: 1, x2: 2, y1: 1, y2: 2}, 2), false);
    assert.strictEqual(distanceMoreThan({x: 0, y: 3}, {x1: 1, x2: 2, y1: 1, y2: 2}, 1), true);
    assert.strictEqual(distanceMoreThan({x: 0, y: 3}, {x1: 1, x2: 2, y1: 1, y2: 2}, 2), false);
    assert.strictEqual(distanceMoreThan({x: 3, y: 0}, {x1: 1, x2: 2, y1: 1, y2: 2}, 1), true);
    assert.strictEqual(distanceMoreThan({x: 3, y: 0}, {x1: 1, x2: 2, y1: 1, y2: 2}, 2), false);

    assert.strictEqual(distanceMoreThan({x: 1, y: 0}, {x1: 1, x2: 2, y1: 1, y2: 2}, 0.5), true);
    assert.strictEqual(distanceMoreThan({x: 1, y: 0}, {x1: 1, x2: 2, y1: 1, y2: 2}, 1), false);
    assert.strictEqual(distanceMoreThan({x: 1, y: 3}, {x1: 1, x2: 2, y1: 1, y2: 2}, 0.5), true);
    assert.strictEqual(distanceMoreThan({x: 1, y: 3}, {x1: 1, x2: 2, y1: 1, y2: 2}, 1), false);
    assert.strictEqual(distanceMoreThan({x: 0, y: 1}, {x1: 1, x2: 2, y1: 1, y2: 2}, 0.5), true);
    assert.strictEqual(distanceMoreThan({x: 0, y: 1}, {x1: 1, x2: 2, y1: 1, y2: 2}, 1), false);
    assert.strictEqual(distanceMoreThan({x: 3, y: 1}, {x1: 1, x2: 2, y1: 1, y2: 2}, 0.5), true);
    assert.strictEqual(distanceMoreThan({x: 3, y: 1}, {x1: 1, x2: 2, y1: 1, y2: 2}, 1), false);

    assert.strictEqual(distanceMoreThan({x: 1, y: 1}, {x1: 0, x2: 2, y1: 0, y2: 2}, 0), false);
    assert.strictEqual(distanceMoreThan({x: 3, y: 3}, {x1: 0, x2: 2, y1: 0, y2: 2}, 0), true);
